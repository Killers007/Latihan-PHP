                    ...
                    <div class="col-md-12">
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group row">
                                <label for="example-text-input" class="col-2 col-form-label">Nama Provinsi</label>
                                <div class="col-10">
                                    <input class="form-control" name="nama_prov" type="text" value="" id="example-text-input">
                                    <div class="cleanError nama_prov"></div>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <?php $foto = isset($dataPasien->foto)? base_url('assets/upload/'.$dataPasien->foto):'https://img2.pngdownload.id/20180216/ehq/kisspng-emoticon-smiley-icon-sick-face-5a8749b772f045.5085153015188156714708.jpg' ?>
                                <div class="col-md-5">
                                    <img class="img-thumbnail" id="viewer" src="<?php echo $foto ?>">
                                    <div class="cleanError foto"></div>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#table').dataTable({
            ...
            {data: 'nama_prov'},
            {
                data: null, searchable: false, orderable: false, render: function (data) {
                    ...
                    var btnUbah =  `<a  onclick="setTitle('Perbaharui', 'Perbaharui')" data-id="`+data.id_prov+`" class="btnEdit btn btn-sm btn-clean btn-icon btn-icon-md" title="View">
                    <i style="color: #366CF3;"class="la la-edit"></i>
                    </a> `;
                    var btnDelete =  `<a  data-id="`+data.id_prov+`" class="btnDelete btn btn-sm btn-clean btn-icon btn-icon-md" title="Delete">
        ...
        {
            key = eval('arr.'+key);
            return dataFull.find(arr => key == value);
        }
        ...
        $(document).on('click', '.btnEdit', function(event) {
            ...
            find = dataFull.find(seep => seep.id_prov == id);
            // find = searchData('id_prov', id);
            ...
            $.each(find, function(index, el) 
            {
                if (index != 'foto') {
                    ...
                    $('#viewer').attr('src', '<?php echo base_url('assets/upload') ?>/'+find.foto);
                }
            }); 
        ...
        function template(data)
        {
            ...
            var label = ['ID Provinsi', 'Nama Provinsi', 'Foto'];
            var indexs = 0
            $.each(data, function(index, el) 
            {
                if (label[indexs] == 'Foto') 
                {
                    el = `<img class="img-thumbnail" id="viewer" src="<?php echo base_url('assets/upload') ?>/`+el+`">`;
                }
