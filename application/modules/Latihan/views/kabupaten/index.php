                ...
                <div class="modal-body">
                   <div class="row">
                        ...
                        <form id="formData" class="kt-form kt-form--label-right">
                            <div class="kt-portlet__body">
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-2 col-form-label">Nama Kabupaten</label>
                                    <div class="col-10">
                                        <input class="form-control" name="nama_kab" type="text" value="" id="example-text-input">
                                        <div class="cleanError nama_kab"></div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-2 col-form-label">ID Provinsi</label>
                                    <div class="col-10">
                                        <?php echo form_dropdown('id_prov', $selectProvinsi, '', ['class' => 'form-control kt-select2', 'style' => 'width: 100%']) ?>
                                        <div class="cleanError id_prov"></div>
                                    </div>
                                </div>
                                        <!-- <div class="form-group row">
                                            <label for="example-text-input" class="col-2 col-form-label">ID Provinsi</label>
                                            <div class="col-10">
                                                <input class="form-control" name="id_prov" type="text" value="" id="example-text-input">
                                                <div class="cleanError id_prov"></div>
                                            </div>
                                        </div> -->
                                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary btnSimpan"><span class="modalSimpan"></span></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                oTable = $('#table').dataTable({
                    ...
                    scrollX: false,
                    lengthMenu: [15, 30],
                    // columnDefs: [{"className": "dt-tengah", "targets": [-1]}],
                    // order: [[0, "asc"], [1, "desc"]],
                    'searching'   : true,
                    pagingType: 'numbers',
                    language:{
                    ...
                    {data: 'nama_prov'},
                    {
                        data: null, searchable: false, orderable: false, render: function (data) {
                            ...
                            var btnUbah =  `<a onclick="setTitle('Perbaharui', 'Perbaharui')" data-id="`+data.id_kab+`" class="btnEdit btn btn-sm btn-clean btn-icon btn-icon-md" title="View">
                            <i style="color: #366CF3;"class="la la-edit"></i>
                            </a> `;
                            var btnDelete =  `<a data-id="`+data.id_kab+`" class="btnDelete btn btn-sm btn-clean btn-icon btn-icon-md" title="Delete">
                ...
                $(document).on('click', '.btnEdit', function(event) {
                    ...
                    find = dataFull.find(seep => seep.id_kab == id);
                ...
                function template(data)
                {
                    ...
                    var label = ['ID Kabupaten', 'Nama Kabupaten', 'Nama Provinsi'];
                    var indexs = 0
